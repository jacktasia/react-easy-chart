...
function calculateExtent(data, valueGenerator) {
  var lo = void 0; // Low
  var hi = void 0; // High
  data.forEach(function (item) {
    var domainRange = (0, _d3Array.extent)(item, valueGenerator);
...
function timeDomainRange(domainRange, parseDate) {
  var _domainRange2 = (0, _slicedToArray3.default)(domainRange, 2);

  var LO = _domainRange2[0];
  var HI = _domainRange2[1];
